...
object LBSMetadataWithSparkContext {
  ...
  @volatile private var population: Broadcast[scala.collection.immutable.Map[(String, String), java.util.TreeMap[Double, java.util.TreeMap[Double, Double]]]] = null;
  @volatile private var zipList: Broadcast[List[Int]] = null;
  def getPopulation(sc: SparkContext): Broadcast[Map[(String, String), java.util.TreeMap[Double, java.util.TreeMap[Double, Double]]]] = {
    if (population == null) {
      synchronized {
        if (population == null) {
